...
public class ArchonActor extends RobotActor {
    ...
    public void act() throws GameActionException {
        ...
        while(true) {
            ...
            updateRoundVars();
            rc.setIndicatorString(0, "TO CENTRAL"+myLocation.distanceSquaredTo(central));
    ...
    public void buildActions() throws GameActionException {
        ...
        //set type to spawn
        RobotType typeToSpawn = RobotType.TURRET;
        if(allyTurretsNum > 2 && allyScoutsNum ==0) {
